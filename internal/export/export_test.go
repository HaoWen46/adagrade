...
func TestBuildZIP_ProducesTheDocumentedFileLayout(t *testing.T) {
	...
	want := []string{
		...
		"algorithms-midterm-2-p3/_all.typ",
		"algorithms-midterm-2-p3/typ/b09901002.typ",
		"algorithms-midterm-2-p3/typ/b09901005.typ",
		"algorithms-midterm-2-p3/typ/b09901007.typ",
		"algorithms-midterm-2-p3/typ/b09901009.typ",
